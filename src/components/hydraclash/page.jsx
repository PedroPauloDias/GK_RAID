    ...
    <div>
      ...
      <div>
        <div className='text-center my-10'>
          ...
          <h1 className={title({ color: "red", size: "sm" })}> Hydra Clash&nbsp;</h1>
        </div>
        <div className='flex flex-col  gap-6 px-2 ml-10 justify-center'>
          <div className="flex flex-row w-full gap-6 px-2    ">
            <div className=' w-full flex align-center p-4'>
            <select
  name="clan"
  value={formData.clan}
  onChange={(e) => {
...
>
  ...
  <option value="Corrupted">CORRUPTED</option>
            ...
            <div className='flex flex-row py-4 gap-2'>
              <div className='flex flex-row rounded-xl w-full text-xs px-2 bg-zinc-800 border border-zinc-800  align-center'>
              <input
  type='search'
...
/>
            ...
            <div className='flex w-full align-center justify-end px-16 py-4'>
